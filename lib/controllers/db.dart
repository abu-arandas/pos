      ...
      onCreate: (db, version) async {
        ...
        ''').then((value) {
          for (int i = 0; i < categories.length; i++) {
            db.insert('Category', {'id': i, 'title': categories[i]});
          }
        });
        ...
        ''').then((value) async {
          for (var product in products) {
            ...
            http.Response response = await http.get(Uri.parse(productModel.image));
...
List categories = ["electronics", "jewelery", "men's clothing", "women's clothing"];
